...
struct ICAnalogInterface {
  // Constructor/destructor
  ICAnalogInterface(DeviceInfoPtr device, Word audioPortID,
                            Byte controllerNumber);
  virtual ~ICAnalogInterface();
...
typedef boost::shared_ptr<ICAnalogInterface>
    ICAnalogInterfacePtr;
