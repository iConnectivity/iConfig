...
void MixerInterface::audioPortIDAndChannelIDForInput(Word audioPortID, Byte mixerInputNumber, int16_t portIDvalue, int16_t channelIDvalue)
{
  MixerInputParm& mixerInputPortParm = device->get<MixerInputParm>(audioPortID, mixerInputNumber);
  mixerInputPortParm.audioSourceAudioPortID(portIDvalue);
  mixerInputPortParm.audioSourceChannelID(channelIDvalue);
