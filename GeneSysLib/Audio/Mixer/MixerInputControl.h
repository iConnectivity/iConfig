...
#ifndef MIXERINPUTCONTROL_H
#define MIXERINPUTCONTROL_H
...
struct GetMixerInputControlCommand
    : public BytesSysexCommand<Command::GetMixerInputControl> {
  GetMixerInputControlCommand(DeviceID deviceID, Word transID,
                                    Word audioPortID)
      : BytesSysexCommand(deviceID, transID) {
    data.append(audioPortID);
  }
};  // GetMixerInputControlCommand

}  // namespace GeneSysLib

#endif // MIXERINPUTCONTROL_H
